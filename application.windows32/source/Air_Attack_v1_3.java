...
public class Air_Attack_v1_3 extends PApplet {
...
//craftSpeed increase
  if (AASpeed <60) {
   AASpeed = AASpeed + 0.001f;
  }
  if (craftSpeed<60) {
   craftSpeed = craftSpeed + 0.001f;
  }
if (mode== 1) {
...
strokeWeight(1);
 ...
 stroke(23, 6, 6);
 rect(city6 - 1, CityY -149, 51.5f, 10);
...
rect(-1, CityY, 800,50);
 ...
 //city 8x
    ...
    rect(city7 + 35.465f, CityY - 70, 30, 10);
    fill(51, 5, 5);
    noStroke();
...
size(800,600); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Air_Attack_v1_3" };
    if (passedArgs != null) {
